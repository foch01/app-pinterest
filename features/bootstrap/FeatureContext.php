...
class FeatureContext implements Context, SnippetAcceptingContext
{
    ...
    /**
     * @Then acces a page accueil en tant que user                                                                                                                                 
     */                                                                                                                                                                            
    public function accesAPageAccueilEnTantQueUser()                                                                                                                               
    {                                                                                                                                                                              
        throw new PendingException();                                                                                                                                              
    }                                                                                                                                                                              

    /**
     * @Given le visiteur entre :arg1 champs de réinitilaisation différents
     */
    public function leVisiteurEntreChampsDeReinitilaisationDifferents($arg1)
    {
        throw new PendingException();
    }
    ...
    /**
     * @Then retour à la fenetre avec champs de réinitialisation mot de passe
     */
    public function retourALaFenetreAvecChampsDeReinitialisationMotDePasse()
    {
        throw new PendingException();
    }

    /**
     * @Given le visiteur entre un mail associé à aucun compte
     */
    public function leVisiteurEntreUnMailAssocieAAucunCompte()
    {
        throw new PendingException();
    }
